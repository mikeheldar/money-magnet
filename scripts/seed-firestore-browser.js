// Browser-based Firestore seed script
// Run this from the browser console after logging in, or create a page to run it
// This uses the client SDK, so it requires authentication
...
import { db, auth } from '../frontend/src/config/firebase'
